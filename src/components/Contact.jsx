...
const copy = {
  es: { label:'Contacto', title:'Reserva tu experiencia', sub:'Completa el formulario y te respondemos en menos de 24 horas.', infoTitle:'Información', details:[{icon:'📍',l:'Dirección',v:'BlueBay Grand Esmeralda Puerto Juarez, Carretera Chetumal Km. 300, 77710 Playa del Carmen, Quintana Roo'},{icon:'📞',l:'Teléfono',v:'+52 984 233 0557'},{icon:'✉️',l:'Email',v:'reservas@inspirationcat.mx'}], qrTitle:'Síguenos en redes', qrItems:[{icon:'📷',label:'Instagram',sub:'@inspirationcatamaran',url:'https://www.instagram.com/inspirationcatamaran?igsi=aHF4ZDhtOXR0NTg4'},{icon:'📱',label:'TikTok',sub:'@inspiration.catam',url:'https://www.tiktok.com/@inspiration.catam?_r=1&_t=ZS-99NgJgM8JwS'},{icon:'💬',label:'WhatsApp',sub:'+52 984 233 0557',url:'https://wa.me/529842330557'},{icon:'📘',label:'Facebook',sub:'Inspiration Catamaran',url:'https://www.facebook.com/InspirationCatamaran'}], formTitle:'Envíanos un mensaje', fields:{name:'Nombre',email:'Email',phone:'Teléfono',service:'Servicio',msg:'Mensaje'}, placeholders:{name:'Tu nombre',email:'tu@email.com',phone:'+52 984 ...',msg:'Cuéntanos sobre tu viaje ideal...'}, services:['Tour Compartido','Tour Privado','Pesca Deportiva','Evento / Boda','Otro'], submit:'Enviar Mensaje', footnote:'Sin compromiso. Te respondemos en menos de 24 horas.', successTitle:'¡Mensaje enviado!', successMsg:'Gracias, te contactaremos pronto para confirmar tu reserva.', successBtn:'Enviar otro mensaje' },
