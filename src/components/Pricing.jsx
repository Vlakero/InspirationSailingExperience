...
const copy = {
  es: { label:'Precios', title:'Elige tu aventura', sub:'Precios fijos, sin cargos ocultos. Todo incluido.',
    plans:[
      ...
      { dur:'4–6 horas', name:'Tour Privado', tag:'El catamarán exclusivamente para tu grupo', pop:true, from:'Desde', amt:'1,200', unit:'USD / embarcación', items:['Duración: 4–6 horas','Itinerario personalizado','Barra libre premium','Comida incluida','Snorkel y equipo','Hasta 20 pasajeros'], cta:'Reservar', ctaStyle:'white' },
    ...
    note:'* Precios en USD. Salidas desde Marina Playacar, Playa del Carmen. Paquetes personalizados disponibles.',
    popular:'★ Más Popular',
  },
  en: { label:'Pricing', title:'Choose your adventure', sub:'Fixed prices, no hidden fees. All included.',
    plans:[
      ...
      { dur:'4–6 hours', name:'Private Tour', tag:'The catamaran exclusively for your group', pop:true, from:'From', amt:'1,200', unit:'USD / vessel', items:['Duration: 4–6 hours','Custom itinerary','Premium open bar','Meal included','Snorkel & gear','Up to 20 passengers'], cta:'Book', ctaStyle:'white' },
  ...
  fr: { label:'Tarifs', title:'Choisissez votre aventure', sub:'Prix fixes, sans frais cachés. Tout inclus.',
    plans:[
      ...
      { dur:'4–6 heures', name:'Tour Privé', tag:'Le catamaran exclusivement pour votre groupe', pop:true, from:'À partir de', amt:'1 200', unit:'USD / bateau', items:['Durée : 4–6 heures','Itinéraire personnalisé','Bar ouvert premium','Repas inclus','Snorkel & équipement','Jusqu\'à 20 passagers'], cta:'Réserver', ctaStyle:'white' },
  ...
  de: { label:'Preise', title:'Wählen Sie Ihr Abenteuer', sub:'Festpreise, keine versteckten Gebühren. Alles inklusive.',
    plans:[
      ...
      { dur:'4–6 Stunden', name:'Privatreise', tag:'Das Katamaran exklusiv für Ihre Gruppe', pop:true, from:'Ab', amt:'1.200', unit:'USD / Schiff', items:['Dauer: 4–6 Stunden','Individuelle Route','Premium offene Bar','Mahlzeit inklusive','Schnorchel & Ausrüstung','Bis zu 20 Passagiere'], cta:'Buchen', ctaStyle:'white' },
